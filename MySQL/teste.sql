...
SELECT CPF, NOME FROM TBCLIENTE LIMIT 10;

SELECT CPF AS CPF_CLIENTE, NOME AS NOME_CLIENTE FROM TBCLIENTE; 

SELECT * FROM TBPRODUTO WHERE EMBALAGEM = 'LATA';

SELECT * FROM TBPRODUTO WHERE EMBALAGEM = 'LATA' AND SABOR = 'MELÂNCIA';

UPDATE TBPRODUTO SET PRECO_LISTA = '3.5' WHERE PRECO_LISTA < 3.7;

UPDATE TBPRODUTO SET PRECO_LISTA = '3.6' WHERE PRECO_LISTA < 3.7 AND SABOR = 'LIMÃO';
...
SELECT * FROM TBCLIENTE WHERE YEAR(DATA_NASCIMENTO) = 1994;

SELECT * FROM TBCLIENTE WHERE MONTH(DATA_NASCIMENTO) = 01;

SELECT * FROM TBCLIENTE WHERE DAY(DATA_NASCIMENTO) = 07;

SELECT * FROM TBCLIENTE WHERE BAIRRO = 'TIJUCA' OR SEXO = 'F';
