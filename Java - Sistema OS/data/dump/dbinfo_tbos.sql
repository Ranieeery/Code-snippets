...
CREATE TABLE `tbos` (
  ...
  PRIMARY KEY (`os`),
  KEY `idcli` (`idcli`),
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `tbclients` (`idcli`)
...
INSERT INTO `tbos` VALUES (1,'2023-03-21 06:21:50','Notebook Positivo','Não liga','Troca de PC','Victor Antares',150.00,1);
...
-- Dump completed on 2023-03-21  3:30:44
