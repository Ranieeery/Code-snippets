...
CREATE TABLE `tbclients` (
  ...
  `enderecocli` varchar(150) DEFAULT NULL,
...
INSERT INTO `tbclients` VALUES (1,'Pedro Cunha Pereira','Rua Aristóteles, 123, Bairro Neverland, São Paulo','11 99999-9999','pedroper@email.com');
